...
- **Разархивируйте** архивный файл, запустите приложение, найдя и открыв файл **RegAndAuth.exe** в папке **net8.0** по следующему пути: _RegAndAuth > RegAndAuth > bin > Debug > net8.0_
